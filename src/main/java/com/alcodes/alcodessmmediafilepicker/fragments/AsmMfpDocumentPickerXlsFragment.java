...
public class AsmMfpDocumentPickerXlsFragment extends Fragment implements AsmMfpDocumentPickerRecyclerViewAdapter.DocumentFilePickerCallbacks, SearchView.OnQueryTextListener, MenuItem.OnActionExpandListener {
    View view;
            ...
            public void onChanged(ArrayList<String> strings) {
                if (strings.size() > 0) {
                   ...
                   // if (mActionMode == null)
                    ...
                    Toast.makeText(getContext(), "active action mode xls", Toast.LENGTH_SHORT).show();
